...
public class Task03 {
    public static void main(String[] args) {
        ...
        // Keep running the program until the user enters "0" to stop
        while (true) {

            // Prompt user to enter a gender character or 0 to quit
            System.out.print("Enter gender (F/f or M/m), or 0 to quit: ");
            ...
            if (gender.equalsIgnoreCase("F")) {
                ...
                // Input was not F, f, M, m, or 0 — prompt the user to try again
